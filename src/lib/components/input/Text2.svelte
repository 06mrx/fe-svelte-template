...
<div class="space-y-1">
  ...
  <input
    ...
    autocomplete={name}
    required={isRequired}
    class="block w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm placeholder-gray-400 shadow-lg transition-colors focus:bg-indigo-500/10 {getFirstError(
      error
    )
